  ...
  return (
    <div>
        ...
        <div className=' mt-3'>
            ...
            <input className=" outline-none w-full border h-40 border-gray-300 rounded-sm px-3 py-1.5 sm:py-2.5 focus:border-blue-500 focus:border-2 hover:border-blue-500" 
