 ...
 function DropDowns(props) {
  return (
    <Menu as="div"   className=" relative inline-block text-left mt-2 ">
      ...
      >
        <Menu.Items  className="origin-top-right absolute overflow-y-auto z-50  right-0 mt-2 w-56 h-60 rounded-md shadow-lg bg-white   ring-1 ring-black ring-opacity-5 focus:outline-none">
          <div className="py-1">
